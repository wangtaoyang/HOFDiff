...
from hofdiff import __path__ as hofdiff_path
...
def load_envs(env_file: Optional[str] = os.path.join(os.path.dirname(hofdiff_path[0]), ".env")) -> None:
    """
...
def log_hyperparameters(
    ...
    def dummy_log_hyperparams(params):
        pass
    trainer.logger.log_hyperparams = dummy_log_hyperparams
