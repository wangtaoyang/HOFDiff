...
import math
from hofdiff.common.sys_utils import log_hyperparameters, PROJECT_ROOT
from hofdiff.common.data_utils import load_datamodule
from hofdiff.data.datamodule import DataModule
...
@hydra.main(config_path=str(PROJECT_ROOT / "conf"), config_name="hofdiff")
