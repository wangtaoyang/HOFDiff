...
from hofdiff.common.data_utils import get_scaler_from_data_list
from hofdiff.common.atomic_utils import remap_values
from hofdiff.common.eval_utils import load_bb_encoder
...
class DataModule(pl.LightningDataModule):
    def __init__(
        ...
        super().__init__()
        print("in init datamodule:", bb_encoder_path)
