...
def run(cfg: DictConfig) -> None:
    ...
    # model_state_dict = ['fc_property.2.weight', 'fc_property.2.bias']
    # checkpoint = torch.load('/opt/wty/hof_synthesis/HOF/MOFDiff/pretrained/mofdiff_ckpt/state_dict.pt')
    # filtered_state_dict = {k: v for k, v in checkpoint.items() if k not in model_state_dict}
