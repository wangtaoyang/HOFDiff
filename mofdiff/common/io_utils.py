...
def readcif(name):
    with open(name, "r") as fi:
            ...
            if cond2 and line_stripped.startswith("loop_"):
                ...
                if line_stripped.startswith("_atom"):
                    ...
                    if line_stripped == "_atom_site_label":
                        ...
                        symbol_index = atom_props_count - 1
        ...
        for _, at in enumerate(atomlines):
            ...
            # print(at_type)
            atomsymbols.append(ln[symbol_index])
        ...
        return lattice_params, atomtypes, positions, atomsymbols

# readcif('/opt/wty/hof_synthesis/HOF/MOFDiff/mofdiff/data/hof_data/1_1/1_1.cif')
